...
$mail = "flavialopezestetica@gmail.com"; //E-mail que você gostaria de receber os resultados dos formmail's
$assunto_auto = "$nome, Sua Mensagem Foi Recebida Com Sucesso!";//Assunto da Auto Resposta
$website =  "http://www.exclusivabelezaeestetica/";//Url do Website
$nome_webmaster = "Exclusiva Beleza e Estética";//Nome do Webmaster do site
